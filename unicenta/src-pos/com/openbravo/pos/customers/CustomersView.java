...
/* if (m_Dirty.equals(true)) {
// Hugh 20 Mar 14
        CustomerInfoGlobal customerInfoGlobal = CustomerInfoGlobal.getInstance();
        
        if (customerInfoGlobal!= null){
            CustomerInfoExt infoExt = customerInfoGlobal.getCustomerInfoExt();
            customerInfoGlobal.setCustomerInfoExt(infoExt);
            
            m_jTaxID.setText("");
            m_jSearchkey.setText("Add Search Key");
...
//            CustomerTransaction customerTransaction = transactionList.get(row);
    ...
    private void initComponents() {
        ...
        jBtnCreateCard.setPreferredSize(new java.awt.Dimension(64, 45));
        ...
        jBtnClearCard.setPreferredSize(new java.awt.Dimension(64, 45));
